define(['dart_sdk', 'packages/flutter_web_ui/ui', 'packages/flutter_web/src/gestures/arena', 'packages/flutter_web/src/foundation/assertions', 'packages/flutter_web/services', 'packages/flutter_web/src/scheduler/binding', 'packages/flutter_web/src/services/clipboard', 'packages/flutter_web/src/physics/clamped_simulation'], function(dart_sdk, ui, arena, assertions, services, binding, clipboard, clamped_simulation) {
  ...
  src__painting__text_style.TextStyle = class TextStyle extends src__foundation__diagnostics.Diagnosticable {
    ...
    getParagraphStyle(opts) {
      ...
      return new src__engine.EngineParagraphStyle.new({textAlign: textAlign, textDirection: textDirection, fontWeight: (t7 = fontWeight, t7 == null ? this.fontWeight : t7), fontStyle: (t7$ = fontStyle, t7$ == null ? this.fontStyle : t7$), fontFamily: (t7$0 = fontFamily, t7$0 == null ? this.fontFamily : t7$0), fontSize: dart.notNull((t7$2 = (t7$1 = fontSize, t7$1 == null ? this.fontSize : t7$1), t7$2 == null ? src__painting__text_style.TextStyle._defaultFontSize : t7$2)) * dart.notNull(textScaleFactor), height: (t7$3 = height, t7$3 == null ? this.height : t7$3), strutStyle: strutStyle == null ? null : new src__engine.EngineStrutStyle.new({fontFamily: strutStyle.fontFamily, fontFamilyFallback: strutStyle.fontFamilyFallback, fontSize: strutStyle.fontSize, height: strutStyle.height, leading: strutStyle.leading, fontWeight: strutStyle.fontWeight, fontStyle: strutStyle.fontStyle, forceStrutHeight: strutStyle.forceStrutHeight}), maxLines: maxLines, ellipsis: ellipsis, locale: locale});
    }
    compareTo(other) {
      if (this === other) return src__painting__basic_types.RenderComparison.identical;
