define(['dart_sdk', 'packages/flutter_web_ui/ui', 'packages/flutter_web/io', 'packages/typed_data/typed_buffers'], function(dart_sdk, ui, io, typed_buffers) {
  ...
  src__foundation__diagnostics.DiagnosticsNode = class DiagnosticsNode extends core.Object {
    ...
    static message(message, opts) {
      ...
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1470, 12, "| !name.endsW");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1471, 12, "        'Name");
    ...
    toString(opts) {
      ...
      if (!(this.style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1657, 12, "\n\n  /// Retur");
      if (!(minLevel != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1658, 12, "presentation of ");
    ...
    get textTreeConfiguration() {
      if (!(this.style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1677, 12, "  return supe");
      switch (this.style) {
  ...
  (src__foundation__diagnostics.DiagnosticsNode.new = function(opts) {
    ...
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1444, 16, "uality\n/// multi");
    if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1445, 16, "via [toStringDeep]. T");
    if (!(name == null || !name[$endsWith](":"))) dart.assertFailed("Names of diagnostic nodes must not end with colons.\n" + "name:\n" + "  \"" + dart.str(name) + "\"", "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1450, 13, "output.\n///\n/// In release mode, fa");
    ;
  ...
  src__foundation__diagnostics.DiagnosticsProperty$ = dart.generic(T => {
    class DiagnosticsProperty extends src__foundation__diagnostics.DiagnosticsNode {
      ...
      [_addTooltip](text) {
        if (!(text != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2660, 12, "iption({Text");
      ...
      [_maybeCacheValue]() {
        ...
        if (!(this[_computeValue] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2729, 12, "alueCallback],\n  /// ");
        try {
    ...
    (DiagnosticsProperty.new = function(name, value, opts) {
      ...
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2492, 16, "erty causes it t");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2493, 16, "higher\n  /// level. F");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2494, 16, " property val");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2495, 16, "ssingIfNull] ");
    ...
    (DiagnosticsProperty.lazy = function(name, computeValue, opts) {
      ...
      this[allowWrap$] = allowWrap;
      this[allowNameWrap$] = allowNameWrap;
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2538, 16, " it to have a lo");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2539, 16, "/ level. For example,");
      if (!(dart.equals(defaultValue, src__foundation__diagnostics.kNoDefaultValue) || T.is(defaultValue))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2540, 16, "teValue` throws an exception, [level]\n  /// will alw");
      if (!(missingIfNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2541, 16, "sticLevel.error].\n  D");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2542, 16, ".lazy(\n    St");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2543, 16, "putePropertyV");
      this[_description] = description;
    ...
    class DiagnosticableMixin extends Object {
      ...
      toString(opts) {
        ...
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 3020, 12, "//    class already describes the children of a node properly or a node has\n///    no children.\n///  * [DiagnosticsProperty], which should be used to");
        t4 = fullString;
  ...
  src__foundation__assertions.FlutterErrorDetails = class FlutterErrorDetails extends src__foundation__diagnostics.Diagnosticable {
    ...
    get summary() {
      ...
      t4 = summary;
      return t4 == null ? new src__foundation__assertions.ErrorSummary.new(this.exceptionAsString()[$split]("\n")[$_get](0)[$trimLeft]()) : t4;
    }
    debugFillProperties(properties) {
  ...
  src__foundation__assertions.FlutterError = class FlutterError extends Error_DiagnosticableTreeMixin$ {
    ...
    static defaultStackFilter(frames) {
      ...
      if (skipped[$length] === 1) {
        ...
        let where = (t4 = LinkedHashSetOfString().from(skipped)[$toList](), t4[$sort](), t4);
    ...
    debugFillProperties(properties) {
      let t4;
      t4 = this.diagnostics;
      t4 == null ? null : t4[$forEach](dart.bind(properties, 'add'));
    }
    toStringShort() {
      return "FlutterError";
    }
  ...
  (src__foundation__assertions.DiagnosticsStackTrace.new = function(name, stack, opts) {
    ...
    let stackFilter = opts && 'stackFilter' in opts ? opts.stackFilter : null;
    let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
    src__foundation__assertions.DiagnosticsStackTrace.__proto__.new.call(this, {name: name, value: stack, properties: (t4 = stackFilter, t4 == null ? dart.fn(src__foundation__assertions.FlutterError.defaultStackFilter, IterableOfStringToIterableOfString()) : t4)(dart.toString(stack)[$trimRight]()[$split]("\n"))[$map](src__foundation__diagnostics.DiagnosticsNode, dart.fn(src__foundation__assertions.DiagnosticsStackTrace._createStackFrame, StringToDiagnosticsNode()))[$toList](), style: src__foundation__diagnostics.DiagnosticsTreeStyle.flat, showSeparator: showSeparator, allowTruncate: true});
    ;
  ...
  (src__foundation__diagnostics.TextTreeConfiguration.new = function(opts) {
    ...
    if (!(prefixLineOne != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 220, 16, "prefixLineOne != null");
    if (!(prefixOtherLines != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 221, 16, "prefixOtherLines != null");
    if (!(prefixLastChildLineOne != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 222, 16, "prefixLastChildLineOne != null");
    if (!(prefixOtherLinesRootNode != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 223, 16, "prefixOtherLinesRootNode != null");
    if (!(linkCharacter != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 224, 16, "linkCharacter != null");
    if (!(propertyPrefixIfChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 225, 16, "propertyPrefixIfChildren != null");
    if (!(propertyPrefixNoChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 226, 16, "propertyPrefixNoChildren != null");
    if (!(lineBreak != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 227, 16, "lineBreak != null");
    if (!(lineBreakProperties != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 228, 16, "lineBreakProperties != null");
    if (!(afterName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 229, 16, "afterName != null");
    if (!(afterDescriptionIfBody != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 230, 16, "afterDescriptionIfBody != null");
    if (!(afterDescription != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 231, 16, "afterDescription != null");
    if (!(beforeProperties != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 232, 16, "beforeProperties != null");
    if (!(afterProperties != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 233, 16, "afterProperties != null");
    if (!(propertySeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 234, 16, "propertySeparator != null");
    if (!(bodyIndent != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 235, 16, "bodyIndent != null");
    if (!(footer != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 236, 16, "footer != null");
    if (!(showChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 237, 16, "showChildren != null");
    if (!(addBlankLineIfNoChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 238, 16, "addBlankLineIfNoChildren != null");
    if (!(isNameOnOwnLine != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 239, 16, "isNameOnOwnLine != null");
    if (!(isBlankLineBetweenPropertiesAndChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 240, 16, "isBlankLineBetweenPropertiesAndChildren != null");
  ...
  src__foundation__diagnostics._PrefixedStringBuilder = class _PrefixedStringBuilder extends core.Object {
    get prefixOtherLines() {
      let t4;
      t4 = this[_nextPrefixOtherLines];
      return t4 == null ? this[_prefixOtherLines] : t4;
    }
            ...
            case src__foundation__diagnostics._WordWrapParseMode.atBreak:
            {
              if (index - startForLengthCalculations > dart.notNull(width) || index === message.length) {
                ...
                if (lastWordEnd === index) {
                  ...
                  if (!(dart.notNull(lastWordStart) > dart.notNull(lastWordEnd))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 948, 22, ";\n            yield line;\n ");
                  start = lastWordStart;
                  mode = src__foundation__diagnostics._WordWrapParseMode.atBreak;
                }
                startForLengthCalculations = dart.notNull(start) - dart.notNull(otherLineOffset);
                if (!addPrefix) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 953, 20, "current p");
                lastWordEnd = null;
              } else {
                lastWordEnd = index;
    ...
    writeRawLines(lines) {
      ...
      if (!dart.test(this[_currentLine].isEmpty)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1030, 12, "\n    String line, {\n");
    ...
    writeStretched(text, targetLineLength) {
      ...
      if (!(dart.notNull(this[_currentLine].length) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1043, 12, "es);\n  }\n\n  /// Write l");
      let targetLength = dart.notNull(targetLineLength) - currentLineLength;
      if (targetLength > 0) {
        if (!text[$isNotEmpty]) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1046, 14, "t.\n  void write");
        let lastChar = text[$_get](text.length - 1);
        if (!(lastChar !== "\n")) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1048, 14, "rentLine.isNotEm");
  ...
  src__foundation__diagnostics.TextTreeRenderer = class TextTreeRenderer extends core.Object {
    [_childTextConfiguration](child, textStyle) {
      let t4;
      let childStyle = (t4 = child, t4 == null ? null : t4.style);
    ...
    render(node, opts) {
      ...
      let isSingleLine = dart.test(src__foundation__diagnostics._isSingleLine(node.style)) && !dart.equals((t4 = parentConfiguration, t4 == null ? null : t4.lineBreakProperties), true);
      ...
      if ((dart.test(properties[$isNotEmpty]) || dart.test(children[$isNotEmpty]) || node.emptyBodyDescription != null) && (dart.test(node.showSeparator) || dart.equals((t4$0 = description, t4$0 == null ? null : t4$0[$isNotEmpty]), true))) {
      ...
      if (dart.test(children[$isNotEmpty]) && dart.test(config.showChildren)) {
        ...
        for (let i = 0; i < dart.notNull(children[$length]); i = i + 1) {
          ...
          if (!(child != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1361, 16, "\n    if (chil");
  ...
  (src__foundation__diagnostics.TextTreeRenderer.new = function(opts) {
    ...
    if (!(minLevel != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1096, 16, "th] and the curr");
  ...
  (src__foundation__diagnostics.MessageProperty.new = function(name, message, opts) {
    let style = opts && 'style' in opts ? opts.style : src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1789, 16, "nosticsNode.");
    if (!(message != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1790, 16, "rves the same r");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1791, 16, "//    without");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1792, 16, "name.\n///  * ");
  ...
  (src__foundation__diagnostics.StringProperty.new = function(name, value, opts) {
    ...
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    this[quoted$] = quoted;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1817, 16, "//\n/// See also:");
    if (!(quoted != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1818, 16, "geProperty], w");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1819, 16, "it for showin");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1820, 16, " instead of d");
  ...
  (src__foundation__diagnostics.DoubleProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1952, 16, "mberToString();\n");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1953, 16, "y describing ");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1954, 16, " with an opti");
  ...
  (src__foundation__diagnostics.DoubleProperty.lazy = function(name, computeValue, opts) {
    ...
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : src__foundation__diagnostics.kNoDefaultValue;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1982, 16, "       unit: uni");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1983, 16, "ip: tooltip,\n");
  ...
  (src__foundation__diagnostics.IntProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2015, 16, ",\n          leve");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2016, 16, ");\n\n  @overri");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2017, 16, "ToString() =>");
  ...
  (src__foundation__diagnostics.PercentProperty.new = function(name, fraction, opts) {
    ...
    let unit = opts && 'unit' in opts ? opts.unit : null;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2051, 16, " [double] to bet");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2052, 16, "ormats it as ");
  ...
  (src__foundation__diagnostics.FlagProperty.new = function(name, opts) {
    ...
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2130, 16, " also:\n///\n///  ");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2131, 16, "rty], which p");
    if (!(ifTrue != null || ifFalse != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2132, 16, "havior describing whether\n///    ");
  ...
  src__foundation__diagnostics.IterableProperty$ = dart.generic(T => {
    ...
    (IterableProperty.new = function(name, value, opts) {
      ...
      let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
      let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2224, 16, "// elements i");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2225, 16, "fEmpty] equals n");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2226, 16, " that an\n  /// empty ");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2227, 16, "s not interes");
  ...
  src__foundation__diagnostics.EnumProperty$ = dart.generic(T => {
    ...
    (EnumProperty.new = function(name, value, opts) {
      let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : src__foundation__diagnostics.kNoDefaultValue;
      let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2324, 16, ")).toList();\n");
  ...
  src__foundation__diagnostics.ObjectFlagProperty$ = dart.generic(T => {
    ...
    (ObjectFlagProperty.new = function(name, value, opts) {
      ...
      if (!(ifPresent != null || ifNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2371, 16, "vides similar functionality describ");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2372, 16, " a [value] is tr");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2373, 16, " ObjectFlagPr");
    ...
    (ObjectFlagProperty.has = function(name, value, opts) {
      let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
      if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2392, 16, "bool showNam");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2393, 16, "gnosticLevel ");
  ...
  src__foundation__diagnostics.DiagnosticableNode$ = dart.generic(T => {
    class DiagnosticableNode extends src__foundation__diagnostics.DiagnosticsNode {
      ...
      get style() {
        let t4;
        return dart.test(src__foundation__constants.kReleaseMode) ? src__foundation__diagnostics.DiagnosticsTreeStyle.none : (t4 = super.style, t4 == null ? this[_builder].defaultDiagnosticsTreeStyle : t4);
      }
      get emptyBodyDescription() {
        return dart.test(src__foundation__constants.kReleaseMode) ? "" : this[_builder].emptyBodyDescription;
      }
      getProperties() {
        return dart.test(src__foundation__constants.kReleaseMode) ? const$7 || (const$7 = dart.constList([], src__foundation__diagnostics.DiagnosticsNode)) : this[_builder].properties;
      }
      getChildren() {
    ...
    (DiagnosticableNode.new = function(opts) {
      ...
      this[value$] = value;
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2813, 16, "f (object is ");
  ...
  src__foundation__diagnostics._DefaultDiagnosticsSerializationDelegate = class _DefaultDiagnosticsSerializationDelegate extends core.Object {
    ...
    copyWith(opts) {
      ...
      return new src__foundation__diagnostics._DefaultDiagnosticsSerializationDelegate.new({subtreeDepth: (t4 = subtreeDepth, t4 == null ? this.subtreeDepth : t4), includeProperties: (t4$ = includeProperties, t4$ == null ? this.includeProperties : t4$)});
    }
  };
  ...
  src__foundation__diagnostics.describeEnum = function(enumEntry) {
    ...
    if (!(indexOfDot !== -1 && indexOfDot < description.length - 1)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2921, 10, "e}#${shortHash(object)}';\n\n// This method exists as a w");
  ...
  src__foundation__change_notifier._MergingListenable = class _MergingListenable extends src__foundation__change_notifier.Listenable {
    addListener(listener) {
      ...
      for (let child of this[_children$]) {
        t6 = child;
        t6 == null ? null : t6.addListener(listener);
      }
    }
    removeListener(listener) {
      let t6;
  ...
  src__foundation__serialization.ReadBuffer = class ReadBuffer extends core.Object {
    ...
    getUint8() {
      let t6;
      return this.data[$getUint8]((t6 = this[_position], this[_position] = dart.notNull(t6) + 1, t6));
    }
    getUint16() {
